                        ...
                        <div class="col-lg-12">
                           <div class="p-3 mb-4 ">
                              <div class="d-sm-flex align-items-center justify-content-between">
                                 <h1 class="h3 mb-4 text-gray-800">Oi, <?= $_SESSION['first_name']; ?>! O que vamos entregar hoje?
                              <div class="btn-startin-container mb-5">
                                  <a href="<?= BASE_URL ?>motorista/servicos" class="site-btn site-btn-secondary">
                                      <span><i class="fa fa-truck"></i> Aceitar serviços</span>
                                  </a>
